...
mapping.register('name', 'univentionThinClientSessionName', None, univention.admin.mapping.ListToString)
mapping.register('description', 'description', None, univention.admin.mapping.ListToString)
mapping.register('session', 'univentionThinClientSessionScript', None, univention.admin.mapping.ListToString)
